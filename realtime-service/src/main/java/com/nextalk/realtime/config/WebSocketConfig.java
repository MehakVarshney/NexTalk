...
import com.nextalk.realtime.security.JwtService;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    private CurrentUser authenticate(StompHeaderAccessor accessor) {
        ...
        return jwtService.parseUser(authHeader.substring(7));
    }
}
